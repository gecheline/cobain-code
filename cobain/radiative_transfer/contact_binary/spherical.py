...
def run(Mc=[0.,0.,0.], normal=[0.,0.,0.], sc_params={}, scale=1., q=1., interp_funcs={}, **kwargs):
    ...
    phis = sc_params['phis']
    les = [interp_funcs['le1'], interp_funcs['le2']]
    chis_interp = [interp_funcs['chi1'], interp_funcs['chi2']]
    Ss_interp = [interp_funcs['J1'], interp_funcs['J2']]
    Is_interp = [interp_funcs['I1'], interp_funcs['I2']]
    r0_scales = kwargs['r0_scales']
    nekmin = kwargs['nekmin']
    angle_breaks = kwargs['angle_breaks']
